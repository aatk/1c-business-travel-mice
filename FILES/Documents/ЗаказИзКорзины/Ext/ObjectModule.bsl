...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	//
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.Услуга") Тогда
		Если ДанныеЗаполнения.Командируемые.Количество()>0 Тогда
			ЭтотОбъект.Командируемый = ДанныеЗаполнения.Командируемые[0].Командируемый;
		КонецЕсли;	
