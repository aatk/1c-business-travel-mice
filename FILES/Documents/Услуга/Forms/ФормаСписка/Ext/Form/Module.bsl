...
Процедура ПриЗакрытииНаСервере()
	УправлениеБТСервер.СохранитьНастройкиСписка( ЭтаФорма );
КонецПроцедуры
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ УправляемыеФормыСервер.ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка, "Вместо") Тогда
		...
		УправлениеБТСервер.ВосстановитьНастройкиСписка( ЭтаФорма );	
		
		ЭтаФорма.Элементы.Список.РежимВыбора = ЭтаФорма.Параметры.РежимВыбора;
		
		Если ПолучитьФункциональнуюОпцию("ИспользоватьБлокчейн") Тогда
			ЭтаФорма.Элементы.ОшибкаЦенности.Видимость = Истина;
		КонецЕсли;
		Если ПолучитьФункциональнуюОпцию("ИспользоватьТревелПолитику") Тогда
			ЭтаФорма.Элементы.ОшибкаТП.Видимость = Истина;
		КонецЕсли;
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если НЕ УправляемыеФормыКлиент.ПриЗакрытии(ЭтаФорма, ЗавершениеРаботы, "Вместо") Тогда
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если НЕ УправляемыеФормыКлиент.ОбработкаОповещения(ЭтаФорма, ИмяСобытия, Параметр, Источник, "Вместо") Тогда		
		Если ИмяСобытия = "ИзменениеУслуги" Тогда
...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	//	Командируемые.Параметры.УстановитьЗначениеПараметра("Ссылка", Элементы.Список.ТекущиеДанные.Ссылка);
	//КонецЕсли;
КонецПроцедуры
