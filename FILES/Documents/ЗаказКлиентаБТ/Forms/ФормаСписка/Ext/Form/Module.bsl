...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ЭтаФорма.Список.Группировка.ДоступныеПоляПолейГруппировок.Элементы
	//ЭтаФорма.Список.Группировка.ДоступныеПоляДополненияПериода.Элементы
...
&НаКлиенте
Процедура Разукрашка(Команда)
	ЭтаФорма.Элементы.УсловноеОформление.Видимость = НЕ ЭтаФорма.Элементы.УсловноеОформление.Видимость;
КонецПроцедуры
