...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)	
	...
	Если НЕ МодульОбъектаСервер.ОбработкаПроведения(ЭтотОбъект, Отказ, РежимПроведения, "Вместо") Тогда
		...
		// регистр ТревелПолитика
		Движения.ТревелПолитика.Записывать = Истина;
		Для Каждого ТекСтрокаПолитики Из РабочиеПолитики Цикл
			Движение = Движения.ТревелПолитика.Добавить();
			Движение.Период = Дата;
			Движение.Партнер = Партнер;
			Движение.Контрагент = Контрагент;
			Движение.Договор = Договор;
			Движение.Политика = ТекСтрокаПолитики.Политика;
			Движение.РазрешеноЗапрещено = ТекСтрокаПолитики.Разрешение;
			Движение.Приоритет = ТекСтрокаПолитики.Приоритет;
			Движение.ШаблонОписания = ТекСтрокаПолитики.ШаблонОписания;
		КонецЦикла;
	КонецЕсли;	
