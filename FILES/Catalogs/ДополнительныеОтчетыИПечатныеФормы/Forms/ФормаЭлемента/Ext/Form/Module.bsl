...
Процедура ОткрытьОбработку(Команда)
	...
	Фильтр = "Внешняя обработка (*.epf)|*.epf|Внешний отчет (*.erf)|*.erf";
...
&НаКлиенте
Процедура СписокКомандПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	Если Копирование Тогда
		Элемент.ТекущиеДанные.ИмяИсходнойКоманды = Элемент.ТекущиеДанные.ИмяКоманды;	
		Элемент.ТекущиеДанные.ИмяКоманды = Элемент.ТекущиеДанные.ИмяКоманды + "new";
	КонецЕсли;
КонецПроцедуры

&НаКлиенте
Процедура СписокКомандПередУдалением(Элемент, Отказ)
	Если Элемент.ТекущиеДанные.ИмяИсходнойКоманды = "" Тогда
		Отказ = Истина;
	КонецЕсли;
КонецПроцедуры
